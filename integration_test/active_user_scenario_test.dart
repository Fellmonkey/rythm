...
void main() {
  ...
  group('Active-user scenario (full-year fixtures)', () {
    ...
    testWidgets('tapping a focus plant opens memory card with correct stats', (
      tester,
    ) async {
      db = await pumpApp(tester);
      await seedFullYear(db);
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        final julyNoSmoking = await db.gardenObjectsDao.getObjectForHabitMonth(
          4,
          2026,
          7,
        );
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        final sepWorkout = await db.gardenObjectsDao.getObjectForHabitMonth(
          3,
          2026,
          9,
        );
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        for (var m = 1; m <= 5; m++) {
          final obj = await db.gardenObjectsDao.getObjectForHabitMonth(
            4,
            2026,
            m,
          );
          expect(
            obj,
            isNotNull,
            reason: 'Month $m should have a garden object',
          );
          expect(
            obj!.objectType,
            'sleepingBulb',
        ...
        final june = await db.gardenObjectsDao.getObjectForHabitMonth(
          4,
          2026,
          6,
        );
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        // Morning Run = habit 1.
        // January: 30% → moss
        final jan = await db.gardenObjectsDao.getObjectForHabitMonth(
          1,
          2026,
          1,
        );
        ...
        final mar = await db.gardenObjectsDao.getObjectForHabitMonth(
          1,
          2026,
          3,
        );
        ...
        // April: 50% → bush
        final apr = await db.gardenObjectsDao.getObjectForHabitMonth(
          1,
          2026,
          4,
        );
        ...
        final aug = await db.gardenObjectsDao.getObjectForHabitMonth(
          1,
          2026,
          8,
        );
        ...
        final dec = await db.gardenObjectsDao.getObjectForHabitMonth(
          1,
          2026,
          12,
        );
    ...
    testWidgets('all 5 habits × 12 months = 60 garden objects in DB', (
      tester,
    ) async {
      db = await pumpApp(tester);
      await seedFullYear(db);
    ...
    testWidgets('scrolling garden path reaches both ends of the year', (
      tester,
    ) async {
      db = await pumpApp(tester);
      await seedFullYear(db);
